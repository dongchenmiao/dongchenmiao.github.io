const translations = {
  ...
  zh: {
    ...
    heroEyebrow: '南京大学 · 博士研究生', heroGreeting: '你好，我是', heroIntro: '我研究如何让基础模型推理得更深入、记忆得更有效，并以更少的计算完成复杂任务。', exploreWork: '了解我的研究', emailMe: '发送邮件', portraitStatus: '当前研究方向', portraitFocus: '隐空间推理 · 具身智能', portraitLocation: '中国 · 南京', scrollCue: '向下探索',
...
const earlierPapers = [
  ...
  {year:'2024',title:'A Novel Deep-Learning-Based QoS Prediction Model for Service Recommendation Utilizing Multi-Stage Multi-Scale Feature Fusion With Individual Evaluations',meta:'IEEE Transactions on Automation Science and Engineering · P. Zhang, W. Huang, Y. Chen, M. Zhou, Y. Al-Turki',url:'https://ieeexplore.ieee.org/document/10137554',rank:'CCF B',rankUrl:'https://www.ccf.org.cn/Academic_Evaluation/Cross_Compre_Emerging/'},
  ...
  {year:'2022',title:'QoS Prediction Model of Cloud Services Based on Deep Learning',meta:'IEEE/CAA Journal of Automatica Sinica · W. Huang, P. Zhang, Y. Chen, M. Zhou, Y. Al-Turki, A. Abusorrah',url:'https://doi.org/10.1109/JAS.2021.1004392',rank:'CAS 1区 · 2025',rankUrl:'https://tsg.gxust.edu.cn/info/1018/3787.htm'},
  {year:'2021',title:'A Fault-Tolerant Model for Performance Optimization of a Fog Computing System',meta:'IEEE Internet of Things Journal · P. Zhang, Y. Chen, M. Zhou, G. Xu, W. Huang, Y. Al-Turki, A. Abusorrah',url:'https://doi.org/10.1109/JIOT.2021.3088417',rank:'CAS New 2026 1区 Top',rankUrl:'https://www.iikx.com/sci/technology/19389.html',rank2:'JCR Q1',rank2Url:'https://www.iikx.com/sci/technology/19389.html',rank3:'CCF C',rank3Url:'https://www.ccf.org.cn/Academic_Evaluation/CN/zgjsjxhtjgjxskw/cl/2023-03-09/787253.shtml'}
];
...
function renderEarlier(language){
  document.querySelector('#earlierList').innerHTML=earlierPapers.map(p=>{
    ...
    const rankNames={
      ...
      'CAS 1区 · 2025':{en:'CAS Zone 1 · 2025',zh:'中科院1区 · 2025'},
      'CAS New 2026 1区 Top':{en:'CAS Emerging Zone 1 · Top (2026)',zh:'2026 新锐1区 · Top'},
      'JCR Q1':{en:'JCR Q1',zh:'JCR Q1'}
    };
